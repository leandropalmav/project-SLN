...
<body>
  ...
  //Se capturan las variables de usuario y contraseña
    ...
    //se busca mendiante el usuario en la BD
      ...
      if (!$result) {
        echo '<p class="error">El usuario o contraseña es incorrecto!</p>';
      } else {
      //En caso de que exista el usuario se verifica la clave utizando el campo contraseña

        if (password_verify($Contraseña, $result['Contraseña'])) {
          // si la contraseña coincide se verifica el tipo de usuario para enviarlo a su respectiva interfaz
          ...
          <div class="row">
            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
              <p class="fst-italic">
                ...
                <input type="password" name="Contraseña" class="form-control" placeholder="Clave" minlength="2" maxlength="20" required>
                <br>
                <br>
