...
//se establecen las variables para filtrar
$fechav=date("Y-m-d");
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="Lista.php">Realizar planificacion</a></li>
      ...
      <section id="services" class="services">
        <div class="container">
          ...
          <div class="section-title">
            <span>Visitas</span>
            <h2>Visitas</h2>
            <p>Las siguientes visitas para el dia de hoy son  son</p>
          </div>
          ...
          <div class="row">
            ...
            <?php
            //query utilizada para mostrar los datos especificos que necesitamos.
            $query='SELECT visitas.IDvisita,jornada.nombreusuario, visitas.NombreCliente, visitas.direccion, jornada.Matricula, vehiculos.estacionamiento,jornada.Fecha from jornada INNER JOIN visitas ON visitas.IDvisita = jornada.numerovisita INNER JOIN vehiculos ON vehiculos.patente=jornada.Matricula';
            ...
            //se captura el array obtenido de la consulta en una varible data.

            while ($data = mysqli_fetch_assoc($resultado)){

              //se pasan los datos de las columnas del array a variables locales
              ...
              //se crean las vistas de pendiendo del filtro seleccionado
