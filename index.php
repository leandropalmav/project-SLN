...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      ...
      <h1>Bienvenido a SLN</h1>
      <h2>WENA PO OE </h2>

      <a href="iniciar.php" class="btn-get-started scrollto">Iniciar Sesión</a>
    </div>
  </section><!-- End Hero -->
  ...
  <section id="team" class="team">
    <div class="container">
      ...
      <div class="section-title">
        <span>Equipo</span>
        <h2>Equipo</h2>
        <p>Más que un equipo una familia.</p>
      </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
          <div class="member">
            ...
            <h4>Leandro Villagran</h4>
            <span>Jefe de Proyecto</span>
            <p>
              Persona que es una persona bastante persona.
            </p>
            <div class="social">
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
          <div class="member">
            <img src="assets/img/team/seba.png" alt="">
            <h4>Sebastian Badilla</h4>
            <span>Analista Programador</span>
            <p>
              Jugador de lol que no supera el rango de HIERRO
            </p>
            <div class="social">
              <a href=""><i class="bi bi-twitter"></i></a>
              <a href=""><i class="bi bi-facebook"></i></a>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
          <div class="member">
            <img src="assets/img/team/nico.png" alt="">
            <h4>Nicolas del Rio</h4>
            <span>Analista Programador</span>
            <p>
              PRO DE VALORANT QUE NUNCA GANO NAH
            </p>
            <div class="social">
              <a href=""><i class="bi bi-twitter"></i></a>
              <a href=""><i class="bi bi-facebook"></i></a>
