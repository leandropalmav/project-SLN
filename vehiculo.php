...
$matricula = mysqli_real_escape_string($con,(strip_tags($_GET["matricula"],ENT_QUOTES)));
if (!isset($matricula)) {
...
<?php
      ...
      //buscador de vehiculos atraves de un select a la tabla vehiuclos.
      
      $sql = mysqli_query($con, "SELECT * from vehiculos where patente='$matricula'");
      if(mysqli_num_rows($sql) == 0){

        header("Location: index.php");
      }else{

        $datosvehiculo = mysqli_fetch_assoc($sql);
...
<div class="container">
    <div class="content">
      <h2>  Detalle del vehiculo &raquo;<?php  echo $matricula; ?></h2>
      <hr/>
       <?php
      //se muestra los datos utilizando la tabla
      ?>
      <table class="table table-striped table-condensed">
        <tr>
          <th width="20%">Matricula del vehiculo</th>
          <td><?php echo $datosvehiculo['patente']; ?></td>
        </tr>
        <tr>
          <th>Marca</th>
          <td><?php echo $datosvehiculo['marca']; ?></td>
        </tr>
        <tr>
          <th>Empresa licitadora</th>
          <td><?php echo $datosvehiculo['licitada']; ?></td>
        </tr>
        
          <th>Kilometraje</th>
          <td><?php echo $datosvehiculo['kilometraje']; ?></td>
        </tr>

         <tr>
          <th>Lugar de estacionamiento </th>
          <td><?php echo $datosvehiculo['estacionamiento']; ?></td>
        </tr>
        <tr>
          <th width="20%">Estado actual del vehiculo</th>
          <td><?php echo $datosvehiculo['Estadov']; ?></td>
        </tr>
